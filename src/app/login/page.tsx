      ...
      <div className="w-full max-w-sm">
        ...
        <div className="flex items-center gap-2 justify-center mb-8">
          ...
          <h1 className="text-xl font-bold text-white">
            WSP Analytics Hub{DEMO && <span className="text-amber-400"> · Demo</span>}
          </h1>
        </div>
        ...
        <div className="bg-[#161b22] border border-white/10 rounded-xl p-6">
          ...
          <p className="text-xs text-gray-500 mb-6">
            {DEMO
              ? 'Demo environment — fabricated data. Enter the shared demo password.'
          ...
          {DEMO ? (
            <form onSubmit={demoSignIn} className="space-y-3">
              <input
                ...
                autoFocus
                className="w-full bg-[#0d1117] border border-white/10 rounded-lg px-3 py-2.5 text-sm text-white placeholder-gray-600 outline-none focus:border-emerald-500/50"
              />
              <button
                type="submit"
